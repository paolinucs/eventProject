...
export const Request = () => {
  ...
  let [permissionDocumentPath, setPermissionDocumentPath] = useState("");
  let [promoterIdCardPath, setPromoterIdCardPath] = useState("");
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      setPermissionDocumentPath(filePath);
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const apiURL = "http://127.0.0.1:8080/api/event_requests/new";

      const requestData = {
        promoterFiscalCode: promoterCf,
        permissionDocumentPath: permissionDocumentPath,
        promoterIdCardPath: promoterIdCardPath,
      ...
      console.log("Response code: ", responseCode.data);
              ...
              <Grid item md="4">
                ...
                >
                  ...
                  <VisuallyHiddenInput
                    type="file"
                    onChange={(e) =>
                      setPermissionDocumentPath(e.target.files[0].name)
                    }
                  />
                </Button>
              ...
              <Grid item md="4">
                ...
                >
                  ...
                  <VisuallyHiddenInput
                    type="file"
                    onChange={(e) =>
                      setPromoterIdCardPath(e.target.files[0].name)
                    }
                  />
                </Button>
              </Grid>
